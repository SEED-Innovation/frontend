  ...
  return (
    ...
    >
      <div>
        ...
        <p className="text-gray-600 mt-1">Monitor active sessions and court usage</p>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-center py-8">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">Session Monitoring Coming Soon</h3>
