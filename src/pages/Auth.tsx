...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen-fix bg-gradient-to-br from-background via-accent/5 to-secondary/10 flex items-center justify-center p-4 relative overflow-hidden">
